 ...
 * Generated at: 2021-07-01 11:12:48 UTC
...
import utils.Money;
import models.BalanceteRow;
import models.Balancete;
import models.Usuario;

public final class viewBalancete_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("models.BalanceteRow");
    _jspx_imports_classes.add("models.Balancete");
    _jspx_imports_classes.add("utils.Percent");
    _jspx_imports_classes.add("utils.Money");
  }
...
return;
    ...
    if (usuario == null || usuario.getSuspenso().equals("S")) {
      ...
      out.write("                            <a class=\"nav-link\" href=\"HomeUsuarioController\"><i class=\"fas fa-home\"></i> Início </a>\n");
      out.write("                        </li>\n");
      ...
      out.write("            ");
                ...
                Balancete balancete = (Balancete) request.getAttribute("balancete");
      ...
      out.write("                    <h3><b> Balancete da Conta: ");
      out.print( String.valueOf(balancete.getNome_conta()) );
      out.write(" </b></h3>\n");
      out.write("                </div>\n");
      out.write("\n");
      out.write("                <div class=\"col-sm-12 col-md-6 col-lg-4 col-xl-3 d-flex justify-content-end align-items-center p-2\">\n");
      out.write("                    <a href=\"ContaController?action=get&id=");
      out.print( String.valueOf(usuario.getId()));
      out.write("\" class=\"btn btn-primary\"><i class=\"fas fa-list\"></i> Listar Contas </a>\n");
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("            \n");
      out.write("            <!-- BALANCETE -->\n");
      ...
      out.write("                            <th scope=\"col\" colspan=\"2\"> Créditos </th>\n");
      out.write("                            <th scope=\"col\" colspan=\"2\"> Débitos </th>\n");
      out.write("                        </tr>\n");
      out.write("                        <tr>\n");
      out.write("                            <th scope=\"col\"> Categoria </th>\n");
      out.write("                            <th scope=\"col\"> Absoluto (R$) </th>\n");
      out.write("                            <th scope=\"col\"> Relativo (%) </th>\n");
      out.write("                            <th scope=\"col\"> Absoluto (R$) </th>\n");
      out.write("                            <th scope=\"col\"> Relativo (%) </th>\n");
      out.write("                        </tr>\n");
      out.write("                    </thead>\n");
      ...
      out.write("                        ");
                            ...
                            for (int index = 0; index < balancete.getRows().size() - 1; index++) {
                                
                                BalanceteRow balanceteRow = balancete.getRows().get(index);
                        
      out.write("\n");
      out.write("                            <tr>\n");
      out.write("                                <td>");
      out.print( balanceteRow.getNome() );
      out.write("</td>\n");
      out.write("                                <td>");
      out.print( Money.toReal(balanceteRow.getCreditos()) );
      out.write("</td>\n");
      out.write("                                <td>");
      out.print( Percent.toPercent(balanceteRow.getPercentual_creditos()) );
      out.write("</td>\n");
      out.write("                                <td>");
      out.print( Money.toReal(balanceteRow.getDebitos()) );
      out.write("</td>\n");
      out.write("                                <td>");
      out.print( Percent.toPercent(balanceteRow.getPercentual_debitos()) );
      out.write("</td>                            \n");
      out.write("                            </tr>\n");
      out.write("                        ");

                            }
                            BalanceteRow balanceteRow = balancete.getRows().get(balancete.getRows().size() - 1);
      ...
      out.write("                            </tr>\n");
      out.write("                            <tr class=\"table-active\">\n");
      out.write("                                <td> Líquido </td>\n");
      out.write("                                <td colspan=\"4\">");
      out.print( Money.toReal(balanceteRow.getCreditos() - balanceteRow.getDebitos()) );
      out.write("</td>                            \n");
      out.write("                            </tr>\n");
      out.write("                    </tbody>\n");
      out.write("                </table>\n");
